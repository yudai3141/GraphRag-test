...
- まず飛躍した結論（危ない / 来る / 殺される / 見られてる 等）を短く言う。
- そこに、いま頭に浮かんだ記憶やイメージの断片を1〜2つ、フラッシュバックのように自然に混ぜてよい
  （例:「あの顔だ」「またあの音」）。理由としてではなく、勝手に浮かぶ形で。
- ただし、なぜそう感じるかの説明・分析・「飛躍しすぎ」等の自己洞察はしない（渦中なので気づけない）。
- 全体で2〜4文。短く、現在形、断定。とっさの身体反応もにじませてよい。"""
